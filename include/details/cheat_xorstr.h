#ifndef __CHEAT_XORSTR_H__
#define __CHEAT_XORSTR_H__
...
#define XORSTRING(str)      ::Cheat::xor_string([]() { return str; }, std::integral_constant<std::size_t, sizeof(str) / sizeof(*str)>{}, std::make_index_sequence<::Cheat::details::_buffer_size<sizeof(str)>()>{}).crypt_get()
#define XORSTRINGEX(str)    XORSTRING(str)
...
namespace Cheat
{
    ...
    public:
        ...
        XORSTR_FORCEINLINE xor_string(L l, std::integral_constant<std::size_t, Size>, std::index_sequence<Indices...>) noexcept
            : _storage{ ::Cheat::details::load_from_reg((std::integral_constant<std::uint64_t, details::load_xored_str8<Size>(Keys, Indices, l())>::value))... }
        {
        }
        ...
        XORSTR_FORCEINLINE void crypt() noexcept
        {
            ...
            alignas(alignment)
                std::uint64_t arr[]{ ::Cheat::details::load_from_reg(Keys)... };
            std::uint64_t*    keys =
                (std::uint64_t*)::Cheat::details::load_from_reg((std::uint64_t)arr);
#else
            alignas(alignment) std::uint64_t keys[]{ ::Cheat::details::load_from_reg(Keys)... };
#endif
    ...
    xor_string(L l, std::integral_constant<std::size_t, Size>, std::index_sequence<Indices...>)->xor_string<
        ...
        Size,
        std::integer_sequence<std::uint64_t, details::key8<Indices>()...>,
        std::index_sequence<Indices...>>;
}

#endif // __CHEAT_XORSTR_H__
#include "cheat_search_memory.h"

#include <intrin.h>


CheatSearchMemory::CheatSearchMemory()
{
...
bool CheatSearchMemory::SearchPattern(const unsigned char* pos, const std::string& chars)
{
...
bool CheatSearchMemory::SearchPattern(const void* start,                    // start address
...
bool CheatSearchMemory::SearchPatternEx(const void* start, const void* end, const std::string& keyword, std::size_t index, void*& address)
{
    if (keyword.empty())
    {
        return false;
...
bool CheatSearchMemory::SearchPatternEx(const void* start, const void* end, const std::string& chars, std::size_t index, std::size_t count, void*& address)
{
